...
import { SiCplusplus, SiScala, SiWebpack } from 'react-icons/si';
import {
  TbArrowsTransferUp,
  TbBrandNextjs,
  TbBrandReactNative,
...
export const skillData: { [key: string]: SkillItem } = {
  ReactJS: {
    ...
    image: (className = 'w-16 h-16') => (<FaReact className={`${className}`} />),
    rating: 100,
  ...
  'HTML/CSS/JS': {
    key: "HTML/CSS/JS",
    types: [SkillType.FrontEnd],
    image: (className = 'w-16 h-16') => (<FaHtml5 className={className} />),
    rating: 90,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  ReactNative: {
    key: "ReactNative",
    types: [SkillType.FrontEnd],
    image: (className = 'w-16 h-16') => (<TbBrandReactNative className={`${className}`} />),
    rating: 50,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  Javascript: {
    ...
    image: (className = 'w-16 h-16') => (<DiJavascript className={className} />),
    rating: 90,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  ExpressJS: {
    ...
    image: (className = 'w-16 h-16') => (<FaNodeJs className={className} />),
    rating: 50,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  ScalaJS: {
    key: "ScalaJS",
    types: [SkillType.BackEnd],
    image: (className = 'w-16 h-16') => (<SiScala className={className} />),
    rating: 50,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  NextJS: {
    key: "NextJS",
    types: [SkillType.BackEnd],
    image: (className = 'w-16 h-16') => (<TbBrandNextjs className={className} />),
    rating: 50,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  Java: {
    key: "Java",
    types: [SkillType.BackEnd],
    image: (className = 'w-16 h-16') => (<DiJava className={className} />),
    rating: 90,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  "C/C++": {
    ...
    image: (className = 'w-16 h-16') => (<SiCplusplus className={className} />),
    rating: 30,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  '.Net': {
    key: ".Net",
    types: [SkillType.BackEnd],
    image: (className = 'w-16 h-16') => (<DiDotnet className={className} />),
    rating: 40,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  Python: {
    key: "Python",
    types: [SkillType.BackEnd],
    image: (className = 'w-16 h-16') => (<FaPython className={className} />),
    rating: 10,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  TypeORM: {
    key: "TypeORM",
    types: [SkillType.BackEnd],
    image: (className = 'w-16 h-16') => (<FaDatabase className={className} />),
    rating: 30,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  Phaser: {
    key: "Phaser",
    types: [SkillType.Game],
    image: (className = 'w-16 h-16') => (<FaGamepad className={className} />),
    rating: 40,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  SQL: {
    ...
    image: (className = 'w-16 h-16') => (<TbSql className={className} />),
    rating: 70,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  MongoDB: {
    ...
    image: (className = 'w-16 h-16') => (<DiMongodb className={className} />),
    rating: 40,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  PostgreSQL: {
    key: "PostgreSQL",
    types: [SkillType.Database, SkillType.BackEnd],
    image: (className = 'w-16 h-16') => (<DiPostgresql className={className} />),
    rating: 60,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  "MicroServices": {
    ...
    image: (className = 'w-16 h-16') => (<FcServices className={className} />),
    rating: 70,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  webpack: {
    ...
    image: (className = 'w-16 h-16') => (<SiWebpack className={className} />),
    rating: 20,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  'NPM Publish': {
    key: "NPM Publish",
    types: [SkillType.Deployment],
    image: (className = 'w-16 h-16') => (<FaNpm className={className} />),
    rating: 50,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  'GIT Flow': {
    ...
    image: (className = 'w-16 h-16') => (<FaGit className={className} />),
    rating: 90,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  Jira: {
    ...
    image: (className = 'w-16 h-16') => (<FaJira className={className} />),
    rating: 60,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  Trello: {
    key: "Trello",
    types: [SkillType.Tools],
    image: (className = 'w-16 h-16') => (<FaTrello className={className} />),
    rating: 60,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  Logistic: {
    ...
    image: (className = 'w-16 h-16') => (<TbArrowsTransferUp className={className} />),
    rating: 80,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  Medical: {
    key: "Medical",
    types: [SkillType.Business],
    image: (className = 'w-16 h-16') => (<AiOutlineAudit className={className} />),
    rating: 80,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  Blockchain: {
    key: "Blockchain",
    types: [SkillType.Business],
    image: (className = 'w-16 h-16') => (<BiBitcoin className={className} />),
    rating: 30,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  Auditing: {
    key: "Auditing",
    types: [SkillType.Business],
    image: (className = 'w-16 h-16') => (<FaHandHoldingMedical className={className} />),
    rating: 40,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
  ...
  'E-commerce': {
    key: "E-commerce",
    types: [SkillType.Business],
    image: (className = 'w-16 h-16') => (<GiCommercialAirplane className={className} />),
    rating: 70,
    ratingDetail: 'Rating based on familiarity',
    shortDescription:
