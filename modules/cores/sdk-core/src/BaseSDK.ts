...
export abstract class BaseSDK implements IBaseSDK {
  ...
  protected _getBaseControl: <ICreationRequest, IUpdatingRequest, IDataResponse, IFilterRequest>(service: IAbstractService<ICreationRequest, IUpdatingRequest, IDataResponse, IFilterRequest>) => IBaseControl<ICreationRequest, IUpdatingRequest, IDataResponse, IFilterRequest> = <ICreationRequest, IUpdatingRequest, IDataResponse, IFilterRequest>(service: IAbstractService<ICreationRequest, IUpdatingRequest, IDataResponse, IFilterRequest>) => {
    return {
